    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="p-2 drop-shadow-boite border-2 border-dark-red bg-white shadow sm:rounded-lg">
                <h1 class="text-3xl font-fjalla font-bold text-center w-full mb-3">{{__('Administrateur créé')}}</h1>
                ...
                <div class="flex justify-center mt-4">
                    <a href={{ route('registerAdministrateur') }} class="bg-dark-yellow px-6 py-1 rounded-md border border-gray-900 font-fjalla" type="submit">
